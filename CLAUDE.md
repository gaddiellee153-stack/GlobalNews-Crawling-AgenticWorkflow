...
│   │   ├── validate_pacs.py               (pACS P1 검증 독립 스크립트 — PA1-PA7 구조적 무결성(PA7: RED < 50 차단) + L0 Anti-Skip Guard(L0a-L0c) + L0d 구조 검증, JSON 출력, Hook 아님 — Orchestrator가 수동 호출)
